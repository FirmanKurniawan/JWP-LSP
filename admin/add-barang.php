    ...
    <div class="main-wrapper">
      ...
      <div class="main-content">
        <section class="section">
          ...
          <form method="POST" action="proses-add-barang.php">
          <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama_barang" id="inputNama4" placeholder="Nama Barang">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Satuan</label>
                        <input type="text" class="form-control" name="satuan" id="inputSatuan4" placeholder="Satuan Barang">
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Harga Jual</label>
                        <input type="number" class="form-control" name="harga_jual" id="inputNama4" placeholder="Harga Jual">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputEmail5">Harga Beli</label>
                        <input type="number" class="form-control" name="harga_beli" id="inputNama5" placeholder="Harga Beli">
                      </div>
                    </div>
