    ...
    <div class="main-wrapper">
      ...
      <div class="main-content">
        <section class="section">
          ...
          <form method="POST" action="proses-add-penjualan.php">
          <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="inputEmail4">Nama Konsumen</label>
                        <input type="text" class="form-control" name="nama_konsumen" id="inputNama4" placeholder="Nama Konsumen">
                      </div>
                    </div>
                    <?php 
                      $nomor_faktur = rand(10000, 99999);
                    ?>
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Nomor Faktur</label>
                        <input type="text" class="form-control" name="nomor_faktur" id="inputSatuan4"value="<?php echo $nomor_faktur;?>" readonly>
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Tanggal Faktur</label>
                        <input type="date" class="form-control" name="tanggal_faktur" id="inputSatuan4" placeholder="Tanggal Faktur">
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-6">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="jumlah" id="inputNama4" placeholder="Jumlah">
                      </div>
                    </div>
