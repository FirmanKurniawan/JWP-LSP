                  ...
                  <div class="card-body">
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $row['kode_barang'];?>">
                        <input type="text" class="form-control" name="nama_barang" id="inputNama4" placeholder="Nama Barang" value="<?php echo $row['nama_barang'];?>">
                      </div>
                      <div class="form-group col-md-6">
                        <label for="inputEmail4">Satuan Barang</label>
                        <input type="text" class="form-control" name="satuan" id="inputNama4" placeholder="Satuan" value="<?php echo $row['satuan'];?>">
                      </div>
                    </div>
                    <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputEmail4">Harga Jual</label>
                      <input type="text" class="form-control" name="harga_jual" id="inputNama4" placeholder="Harga Jual" value="<?php echo $row['harga_jual'];?>">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputEmail4">Harga Beli</label>
                      <input type="text" class="form-control" name="harga_beli" id="inputNama4" placeholder="Harga Beli" value="<?php echo $row['harga_beli'];?>">
                    </div>
                    </div>
                  </div>
