...
<body>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <?php  
              include '../connect.php';
              $master_barang = mysqli_query($koneksi, "SELECT * FROM master_barang");
              $penjualan = mysqli_query($koneksi, "SELECT * FROM penjualan");
              $count_barang = mysqli_num_rows($master_barang);
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://i0.wp.com/dconsultingbusinessconsultant.com/wp-content/uploads/2017/07/5-Panduan-agar-Stok-Barang-Jualan-Terdata-Dengan-Mudah-Sumber-Gambar-pangestikapradipta.blogspotcom.jpg?ssl=1" class="d-block w-100" style="height: 400px;width: 100px;">
    </div>
